...
class _HRMSAddPatientScreenState extends State<HRMSAddPatientScreen> {
  ...
  TextEditingController brgyController = TextEditingController(text: 'Puerto');
  TextEditingController cityController =
      TextEditingController(text: 'Cagayan de Oro');
  TextEditingController provinceController =
      TextEditingController(text: 'Misamis Oriental');
